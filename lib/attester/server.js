...
var SlaveController = require("../test-server/slave-controller.js");
...
exports.addSlaveController = function () {
    var slaveController = new SlaveController();
    testServer.addSlaveController(slaveController);
